  ...
  const buttonIcon = useMemo(() => {
    if (currentPage !== "main") {
      ...
      return (
        ...
        >
          <path
            d="M13.2414 17C21.6444 17 26.3556 17 34.7586 17C35.5862 17 36 16.3284 36 15.5C36 14.6716 35.5862 14 34.7586 14C34.7586 14 19.5576 14.0003 13.2414 14C12.4138 14 12 14.6716 12 15.5C12 16.3284 12.4138 17 13.2414 17Z"
            fill="#AC9B92"
          />
          <path
            d="M13.2414 25C21.6444 25 26.3556 25 34.7586 25C35.5862 25 36 24.3284 36 23.5C36 22.6716 35.5862 22 34.7586 22C34.7586 22 19.5576 22.0003 13.2414 22C12.4138 22 12 22.6716 12 23.5C12 24.3284 12.4138 25 13.2414 25Z"
            fill="#AC9B92"
          />
          <path
            d="M13.2414 33C21.6444 33 26.3556 33 34.7586 33C35.5862 33 36 32.3284 36 31.5C36 30.6716 35.5862 30 34.7586 30C34.7586 30 19.5576 30.0003 13.2414 30C12.4138 30 12 30.6716 12 31.5C12 32.3284 12.4138 33 13.2414 33Z"
            fill="#AC9B92"
          />
        </svg>
      );
    ...
    <div className="fixed top-0 left-0 z-50 flex items-start w-full h-full gap-3 px-8 pointer-events-none py-9">
      ...
      >
        ...
        <div
          ...
          className={`absolute left-0.5 right-0.5 top-full border-ohi-front rounded-[24px] ${
            expand
              ? "max-h-[200px] py-5 px-2 border opacity-100"
              : "max-h-0 py-0 border-[0px] opacity-0"
        ...
        >
          ...
          <button onClick={() => handleNavBtnClick("about")}>
            ...
            >
              ...
              />
              <path
                d="M7.41176 13.5832C6.70588 14.6665 6.35294 18.2776 6.35294 18.2776H12L12 12.4999L9.88228 12.4999C8.47057 12.4999 8.11763 12.4999 7.41176 13.5832Z"
                fill="#AC9B92"
              />
              <path
                d="M16.5882 13.5832C17.2941 14.6666 17.6471 18.2777 17.6471 18.2777L12 18.2776L12 12.4999L14.1177 12.4999C15.5294 12.4999 15.8824 12.4999 16.5882 13.5832Z"
                fill="#AC9B92"
              />
              <path
                fillRule="evenodd"
      ...
      <div className="relative w-full">
        ...
        >
          ...
          <p className="mb-3 text-base font-normal tracking-widest font-lato">
            We are sesame salt, group of creators conspiring unconventional
            things.
            <br />
            You are invited to our first ever “super-exclusive” open house
            party.
            <br />
        ...
        >
          ...
          <p className="mb-3 text-base font-normal tracking-widest font-lato">
            ...
            <br />
            We aim to go beyond the norm and pursue making creative &
        ...
        >
          ...
          <p className="mb-3 text-base font-normal tracking-widest font-lato">
            Please let us know if you’re attending. You may also leave any
            further inquiries.
            <br />
