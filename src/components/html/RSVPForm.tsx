    ...
    <div className={`pointer-events-auto fixed z-0 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[80%] max-w-[780px] h-[80vh] max-h-[506px] rounded-[4px] bg-ohi-front shadow-[4px_4px_12px_4px_rgba(0,_0,_0,_0.35)] py-9 px-8 flex gap-5 animate-fadein opacity-0`}>
      ...
      <div className="flex flex-col items-end justify-between w-1/3">
        ...
        <div className="flex flex-col items-end">
          ...
          <button type="button" className=" disabled:bg-[#514949] disabled:text-[#797878] bg-ohi-accent rounded-[4px] text-white font-bold text-[16px] leading-[16px] tracking-[-0.16px] py-2 w-full max-w-[155px]" disabled={sendEnabled === false} onClick={sendEmail}>
            Send
          </button>
        </div>
      </div>
